...
(function($) {
  ...
  var audioEngine = function() {
    ...
    var html5Driver = function() {
      ...
      $('<div class="sc-player-engine-container' + artist + '"></div>').appendTo(document.body).append(player);
      ...
      return {
        load: function(track) {
          ...
          if(player){
            ...
            $('<div class="sc-player-engine-container' + artist + '"></div>').appendTo(document.body).html(flashHtml(url));
          }
        },
        play: function() {
...
//              $.getJSON(apiUrl, function(data) {
  ...
  $.scPlayer.destroy = function() {
    $('.sc-player, .sc-player-engine-container'+artist).remove();
  };
